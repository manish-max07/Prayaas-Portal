              ...
              <div className="flex items-center justify-between mb-1.5">
                ...
                <span
                  className={`text-[11px] font-medium flex items-center gap-1 ${
                    isPasswordLongEnough ? "text-emerald-600" : "text-slate-400"
                  }`}
                >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`w-full rounded-xl border pl-10 pr-10 py-2.5 text-xs sm:text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none transition-all ${
                    passwordsMismatched
